...
namespace AspNetStateService.Azure.Storage.Blob
{
    ...
    /// <summary>
    /// Converts session IDs into paths usable by the Azure Storage Blob service.
    /// </summary>
    [RegisterAs(typeof(IStatePathProvider))]
    public class DefaultStatePathProvider : IStatePathProvider
    {
        ...
        /// <summary>
        /// Gets the expected blob path for the given session ID.
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
